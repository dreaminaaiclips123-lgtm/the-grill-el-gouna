...
- **Signature interaction:** dropped. A canvas ember-particle overlay was tried behind the hero and read as a cheap animated-firelights effect on top of a real fire photo; removed per client feedback. The hero relies on the photograph, gradient, and typography alone. Do not re-add a floating-particle effect here.
